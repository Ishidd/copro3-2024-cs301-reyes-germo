...
namespace ConsoleApp6
{
    ...
    public class Game : dkopaAlamParaSaan
    {
        ...
        string characterDatabase = @"Data Source=(localdb)\MSSQLLocalDB;AttachDbFilename=C:\USERS\RYZEN\SOURCE\REPOS\CONSOLEAPP6\CONSOLEAPP6\CHARACTERDATABASE.MDF;Integrated Security=True;Connect Timeout=30;Encrypt=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
